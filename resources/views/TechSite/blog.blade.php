...
<div class="entity_wrapper">
    <div class="entity_title">
        <h1><a href="" target="_self">{{ $book->title}}</a>
        </h1>
    </div>
    <div>
        <form style = 'display:inline-block;'>
            <form style = 'display:inline-block;'>
                <a href = '{{route('adminedit',["id"=>$book->id])}}' class = 'btn btn-warning'>Edit</a>
            </form>
            ...
            <form style = 'display:inline-block;'>
                <a class = 'btn btn-success' href = '{{ route('showmore',["id"=>$book->id])}}'>See more
                </a>
            </form>            
        </form>
    ...
    <div class="entity_meta">
        <a href="#">{{ $book->add_date }}</a>, by: <a href="#">{{ $book->author }}</a>
    </div>
    <!-- entity_meta -->
    ...
    <div class="entity_thumb">
        <img class="img-responsive" src="{{ $book->image }}" alt="no image has been uploaded">
    </div>
    <!-- entity_thumb -->
